...
#define HOMING_TRAVEL_Z_MM      150.0f

#define HOMING_BACKOFF_XY_MM      10.0f
#define HOMING_BACKOFF_Z_MM       10.0f

/* HOMING SPEED*/
#define HOMING_FAST_XY_MM_S     60.0f
#define HOMING_SLOW_XY_MM_S      25.0f

#define HOMING_FAST_Z_MM_S       50.0f
#define HOMING_SLOW_Z_MM_S        10.0f

#define HOMING_ACCEL_XY_MM_S2    500.0f
